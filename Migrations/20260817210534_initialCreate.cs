        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirlineStaffId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FarClasses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FarClasses_Flights_FlightId",
                        column: x => x.FlightId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QueueTickets_Flights_FlightId",
                        column: x => x.FlightId,
                        principalTable: "Flights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FareClassId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeatHolds_FarClasses_FareClassId",
                        column: x => x.FareClassId,
                        principalTable: "FarClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FarClasses_FlightId",
                table: "FarClasses",
                column: "FlightId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueTickets_FlightId",
                table: "QueueTickets",
                column: "FlightId");

            migrationBuilder.CreateIndex(
                name: "IX_SeatHolds_FareClassId",
                table: "SeatHolds",
                column: "FareClassId");
        }
